...
export class Plane {
    ...
    intersectLine(line, out) {
        ...
        return out.copy(direction).multiplyScalar(t).add(line.start);
    }
    intersectsLine(line) {
    ...
    coplanarPoint(out) {
        return out.copy(this.normal).multiplyScalar(-this.constant);
    }
